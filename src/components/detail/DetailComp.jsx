    ...
    <div className='flex gap-10 my-10'>
        ...
        <div className=''>
            ...
            <div className='flex items-center gap-5 my-4'>
               ...
               <div className='w-10 text-center text-4xl font-bold' type="text">{quantity}</div>
                <div onClick={increment} className='text-4xl cursor-pointer'>+</div>
            </div>
            <div onClick={addBasket} className="my-4 border w-[200px] text-2xl rounded-md bg-gray-400 cursor-pointer h-16 flex items-center justify-center">Sepete Ekle</div>
